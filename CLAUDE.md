...
> ## 🪨 Bound by The Nine
>
> **This repository is bound by [The Nine](https://thenine.foundation),
> a discipline of verifiable trust. The canonical agent binding lives in
> [`AGENTS.md`](./AGENTS.md), pinned to schema `v0.1.0`. Read it first.**
>
> The Nine governs everything below: P1 (minimize the secret) · P2 (prove,
> don't grant) · P3 (architect for change) · P4 (never claim more than you
> can verify) · P5 (the rule binds its keeper) · P6 (be safely endable) ·
> P7 (let entry be freely chosen) · P8 (do not trap, coerce, or extract)
> · P9 (trust itself cannot be generated by the agent — the leap is the
> human's).
>
> The existing **§ Partner agreement** section further down restates clauses
> #1–#4 from this repo's lived practice. Those clauses are now formally
> understood as a project-specific expression of P2, P4, P5, P7, P9. AGENTS.md
> is the source of truth; the partner-agreement narrative is kept for
> historical context (how the discipline arrived in this repo) and the
> human-language reminder of why it matters. If they ever conflict,
> AGENTS.md wins per P5.
>
> Derivation chain (per P2): edit `chapter2/THE-NINE.schema.json` upstream
> at The Nine Master Package, re-run `derive.py`, copy the new AGENTS.md
> over this one. Never hand-edit AGENTS.md.
